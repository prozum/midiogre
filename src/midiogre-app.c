...
static void midiogre_app_init(MidiogreApp *app)
{
}

/** Is called when midiogre is launched with no commandline arguments */
static void midiogre_app_activate(GApplication *app)
{
...
static void midiogre_app_open(GApplication  *app,
                              GFile        **files,
                              gint           n_files,
                              const gchar   *hint)
{
...
static void midiogre_app_class_init (MidiogreAppClass *class)
{
